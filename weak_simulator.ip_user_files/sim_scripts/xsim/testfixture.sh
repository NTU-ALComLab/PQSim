...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xpm -L xil_defaultlib -L fifo_generator_v13_2_10 -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot testfixture xil_defaultlib.testfixture xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim testfixture -key {Behavioral:sim_1:Functional:testfixture} -tclbatch cmd.tcl -protoinst "protoinst_files/mainDesign.protoinst" -log simulate.log
}
...
map_local_libs()
{
  ...
  local_libs=(xpm fifo_generator_v13_2_10)
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb testfixture.wdb xsim.dir libdpi.so)
