...
design_libs_elab="-libname xpm -libname xil_defaultlib -libname fifo_generator_v13_2_10 -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm xil_defaultlib fifo_generator_v13_2_10)
...
compile()
{
  xmvlog -work xpm $xmvlog_opts -sv +incdir+"../../../weak_simulator.gen/sources_1/bd/mainDesign/ipshared/3242" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts +incdir+"../../../weak_simulator.gen/sources_1/bd/mainDesign/ipshared/3242" \
  ...
  xmvlog -work fifo_generator_v13_2_10 $xmvlog_opts +incdir+"../../../weak_simulator.gen/sources_1/bd/mainDesign/ipshared/3242" \
  ...
  xmvlog -work xil_defaultlib $xmvlog_opts -sv +incdir+"../../../weak_simulator.gen/sources_1/bd/mainDesign/ipshared/3242" \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.testfixture xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.testfixture -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log testfixture_sc.so .tmp_log xcelium_lib waves.shm c.obj)
