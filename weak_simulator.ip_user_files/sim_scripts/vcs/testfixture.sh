...
#
# Script generated by Vivado on Tue Nov 05 15:40:41 +0800 2024
# SW Build 5076996 on Wed May 22 18:37:14 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : testfixture.sh
...
#
# Usage        : testfixture.sh
#                testfixture.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                testfixture.sh [-reset_run]
#                testfixture.sh [-reset_log]
#                testfixture.sh [-help]
#
...
#                script (type 'testfixture.sh -help' for more information).
#
...
design_libs=(xpm xil_defaultlib fifo_generator_v13_2_10)

# simulation root library directory
sim_lib_dir="vcs_lib"

# script info
echo -e "testfixture.sh - Script generated by export_simulation (Vivado v2024.1 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./testfixture.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../weak_simulator.gen/sources_1/bd/mainDesign/ipshared/3242" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../weak_simulator.gen/sources_1/bd/mainDesign/ipshared/3242" \
  "../../../../../Vivado/ projects/weak_simulator/weak_simulator.srcs/sources_1/new/define.v" \
  "../../../../../Vivado/ projects/weak_simulator/weak_simulator.srcs/sources_1/new/Core.v" \
  "../../../../../Vivado/ projects/weak_simulator/weak_simulator.srcs/sources_1/new/LUT_tgate.v" \
  "../../../../../Vivado/ projects/weak_simulator/weak_simulator.srcs/sources_1/new/measureClifford.v" \
  "../../../../../Vivado/ projects/weak_simulator/weak_simulator.srcs/sources_1/new/core_wrapper.v" \
  "../../../../../Vivado/ projects/weak_simulator/weak_simulator.srcs/sources_1/new/uart.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work fifo_generator_v13_2_10 $vlogan_opts +v2k +incdir+"../../../weak_simulator.gen/sources_1/bd/mainDesign/ipshared/3242" \
  ...
  "../../../../../Vivado/ projects/weak_simulator/weak_simulator.gen/sources_1/bd/mainDesign/hdl/mainDesign_wrapper.v" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null

  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"../../../weak_simulator.gen/sources_1/bd/mainDesign/ipshared/3242" \
  "../../../../../Vivado/ projects/weak_simulator/weak_simulator.srcs/sim_1/new/testfixture.sv" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vlogan.log 2>/dev/null
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.testfixture xil_defaultlib.glbl -o testfixture_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./testfixture_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key testfixture_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc testfixture_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./testfixture.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: testfixture.sh [-help]\n\
Usage: testfixture.sh [-step]\n\
Usage: testfixture.sh [-lib_map_path]\n\
Usage: testfixture.sh [-reset_run]\n\
Usage: testfixture.sh [-reset_log]\n\
Usage: testfixture.sh [-keep_index]\n\
Usage: testfixture.sh [-noclean_files]\n\n\
