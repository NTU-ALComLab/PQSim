...
HD_PWD='D:/Vivado projects/weak_simulator/weak_simulator.runs/mainDesign_uart_rx_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mainDesign_uart_rx_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mainDesign_uart_rx_0_0.tcl
