...
# ===========================================================
    fragment = dict()
    (n_qubits_new, t_gates, ccx_gates, clifford_inputs, clifford_observables, (clifford_circuit, quantum_inputs, quantum_outputs)) = parseBlif(filename, outname)
...
if __name__ == '__main__':
    fragment = get_fragments_from_file("test.qasm", "test_out.qasm")
    # fragment = []
