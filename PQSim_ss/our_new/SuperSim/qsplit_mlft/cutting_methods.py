...
class Fragment:
    ...
    def __init__(
        ...
        # print(self.quantum_inputs)
        # print(self.quantum_outputs)
        # print(self.circuit_outputs)
        # print(self.circuit.all_qubits())
...
def cut_circuit(
    ...
    fragments = {}
    for fragment_index, subcircuit_moments in enumerate(circuit.factorize()):#fragment_index = 0 should be clifford
        subcircuit = cirq.Circuit(subcircuit_moments)
        fragment_qubits = subcircuit.all_qubits()
        print(f"fragment_{fragment_index}")
...
def perform_fragment_tomography(
    ...
    num_variants = sum(
        len(get_prep_states(prep_basis)) ** len(fragment.quantum_inputs)
    ...
    return {
        fragment_key: perform_single_fragment_tomography(
            fragment, prep_basis, (repetitions_per_variant if fragment_key=='fragment_0' else 0), fragment_key=='fragment_0'
        )
...
def perform_single_fragment_tomography(
    ...
    print('quantum_inputs: ', quantum_inputs)
    # if repetitions_per_variant:
    #     print('repetitions_per_variant')
    #     print(repetitions_per_variant)
    #     print('end repetitions_per_variant')
    # else:
    ...
    if repetitions_per_variant:
        ...
        #     # clifford_simulator = cirq.Simulator(seed=seed)
        # else:
    ...
    print('tomography_data: ', tomography_data)
